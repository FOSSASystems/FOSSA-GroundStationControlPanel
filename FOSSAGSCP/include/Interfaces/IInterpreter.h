...
public:
    ...
    virtual IGroundStationSerialMessage* Create_GroundStationSerialMessage(char directionBit, char operationId, uint8_t functionId, uint8_t optDataLength, char* optData, bool encrypt) = 0;
};
